...
// Changes Globals:		-
//===========================================================================
static void ShowGPSText(gentity_t *ent, vec3_t goal) {
...
// Changes Globals:		-
//===========================================================================
static void TeamHelp_f(gentity_t *ent) {
	int i, j;
	float radius, weight, bestweight, dist;
	char buf[144];
	vec3_t eorg;
	gentity_t *item, *bestitem;
	...
	bestweight = 0;
	bestitem = NULL;
	for (item = g_entities; item < &g_entities[globals.num_edicts]; item++) {
	...
	BotClientCommand(ent - g_entities - 1, "say_team", buf, NULL);
...
// Changes Globals:		-
//===========================================================================
static void CheckPoint_f(gentity_t *ent) {
...
//===========================================================================
#ifdef BOT_DEBUG
static void Cmd_ServerCommand(gentity_t *ent) {
	char str[1024];
	int i;
...
//===========================================================================
#ifdef BOT_DEBUG
static bool BotDebugCmd(char *cmd, gentity_t *ent, int server) {
	return true;
...
// Changes Globals:		-
//===========================================================================
static bool BotServerCmd(char *cmd, gentity_t *ent, int server) {
...
// Changes Globals:		-
//===========================================================================
bool BotCmd(char *cmd, gentity_t *ent, int server) {
