...
// Changes Globals:		-
//===========================================================================
static void ShowLine(gentity_t *line, vec3_t start, vec3_t end, int color) {
...
// Changes Globals:		-
//===========================================================================
static gentity_t *CreateLine(void) {
	gentity_t *line;
	line = G_Spawn();
	//classname
...
// Changes Globals:		-
//===========================================================================
void ToggleVisibleBoundingBox(gentity_t *ent) {
#ifdef OBSERVER
	gentity_t *cam;
...
// Changes Globals:		-
//===========================================================================
void SetVisibleBoundingBox(visiblebbox_t *box, gentity_t *ent) {
