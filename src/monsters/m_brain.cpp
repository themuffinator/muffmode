...
MONSTERINFO_SEARCH(brain_search) (gentity_t *self) -> void {
...
MONSTERINFO_STAND(brain_stand) (gentity_t *self) -> void {
...
MONSTERINFO_IDLE(brain_idle) (gentity_t *self) -> void {
...
MONSTERINFO_WALK(brain_walk) (gentity_t *self) -> void {
...
mframe_t brain_frames_death1[] = {
	...
	{ ai_move, 0, monster_footstep },
	{ ai_move, -2 },
	{ ai_move, 9, [](gentity_t *self) { brain_shrink(self); monster_footstep(self); } },
	{ ai_move },
	{ ai_move },
	{ ai_move },
	{ ai_move, 0, monster_footstep },
...
static void brain_swing_right(gentity_t *self) {
...
static void brain_laserbeam(gentity_t *self) {
	// dis is my right eye
...
MONSTERINFO_ATTACK(brain_attack) (gentity_t *self) -> void {
